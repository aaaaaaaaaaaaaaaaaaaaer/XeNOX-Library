...
task.spawn(function()
    while task.wait(0.02) do 
        ...
        blob.ImageColor3 = Color3.fromRGB(0, 20, 100)
        ...
        trail.Position = UDim2.new(0, mouse.X - mainFrame.AbsolutePosition.X - 3, 0, mouse.Y - mainFrame.AbsolutePosition.Y - 3)
        trail.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
        trail.BorderSizePixel = 0
        trail.ZIndex = 2
        trail.Parent = mainFrame
        Instance.new("UICorner", trail).CornerRadius = UDim.new(1, 0)

        game:GetService("TweenService"):Create(star, TweenInfo.new(0.6, Enum.EasingStyle.Linear), {
            Position = UDim2.new(star.Position.X.Scale, 0, 1.2, 0), 
            BackgroundTransparency = 1
        }):Play()
        game:GetService("Debris"):AddItem(star, 0.6)
        
        game:GetService("TweenService"):Create(trail, TweenInfo.new(0.4), {
            BackgroundTransparency = 1, 
...
function _G.XeNOX:CreateTab(name)
    ...
    function tabObj:CreateButton(text, callback)
        ...
        b.BackgroundColor3 = Color3.fromRGB(25, 55, 95)
