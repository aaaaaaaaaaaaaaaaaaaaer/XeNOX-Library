...
function XELIB:MakeWindow(config)
    ...
    if UserInputService.TouchEnabled or UserInputService.GamepadEnabled then
        ...
        toggleBtn.MouseButton1Click:Connect(function()
            ...
            if menuOpen then
                ...
                uiScale.Scale = 0.8
                Tween(uiScale, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Scale = 1})
                Tween(mainFrame, TweenInfo.new(0.3), {BackgroundTransparency = 0.4})
            else
                Tween(uiScale, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Scale = 0.8})
    ...
    local function StyleButton(btn)
        ...
        btn.MouseEnter:Connect(function()
            Tween(btn, TweenInfo.new(0.2), {BackgroundTransparency = 0.2})
        end)
    ...
    function Window:Notify(titleText, descText, duration)
        ...
        Tween(notif, TweenInfo.new(0.4, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {Position = UDim2.new(0, 0, 0, 0), BackgroundTransparency = 0.1})
        Tween(stroke, TweenInfo.new(0.4), {Transparency = 0})
        Tween(tLbl, TweenInfo.new(0.4), {TextTransparency = 0})
        Tween(dLbl, TweenInfo.new(0.4), {TextTransparency = 0})
        ...
        task.delay(duration, function()
            ...
            Tween(notif, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.In), {Position = UDim2.new(1, 50, 0, 0), BackgroundTransparency = 1})
            Tween(stroke, TweenInfo.new(0.4), {Transparency = 1})
            Tween(tLbl, TweenInfo.new(0.4), {TextTransparency = 1})
            Tween(dLbl, TweenInfo.new(0.4), {TextTransparency = 1})
    ...
    function Window:AddTab(name)
        ...
        function Tab:AddButton(text, callback)
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                Tween(btn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.new(1, 1, 1)})
                task.delay(0.1, function()
                    Tween(btn, TweenInfo.new(0.2), {BackgroundColor3 = orig})
                end)
        ...
        function Tab:AddToggle(text, default, callback)
            ...
            bg.MouseButton1Click:Connect(function()
                enabled = not enabled
                Tween(bg, TweenInfo.new(0.2), {BackgroundColor3 = enabled and theme.Button or theme.Shade})
        ...
        function Tab:AddDropdown(text, options, callback)
            ...
            for _, opt in ipairs(options) do
                ...
                optBtn.MouseButton1Click:Connect(function()
                    ...
                    btn.Text = selected
                    open = false
                    Tween(dropFrame, TweenInfo.new(0.2), {Size = UDim2.new(0, 120, 0, 0)})
            ...
            btn.MouseButton1Click:Connect(function()
                ...
                Tween(dropFrame, TweenInfo.new(0.2), {Size = UDim2.new(0, 120, 0, open and h or 0)})
            end)
        end
